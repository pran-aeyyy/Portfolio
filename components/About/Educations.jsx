      ...
      >
        <Stepper activeStep={activeStep} orientation="vertical">
          ...
          <Step>
            ...
            <StepContent>
              <p className="text-lg">
                I passed my higher secondary examination from Allenhouse 
                Public School in 2021. I scored 91% in my secondary
                examination.
                <br />
              </p>
              <Box sx={{ mb: 2 }}>
          ...
          <Step>
            ...
            <StepContent>
              <p className="text-lg">
                I am cuurently pursuing a Bachelors degree in Technology
                in the field of AI-ML. I am currently in the last sem of my college. 
              </p>
              <Box sx={{ mb: 2 }}>
                <div>
                  <Button
